...
@section('topline','Categories')
@section('btn')
    <div class="col-6 text-right">
        <button class="btn btn-success btn-sm" onclick="location.href='{{route('add.cats')}}'">+ Add New Category</button>
    </div>
@endsection
@section('content')
...
<div class="card shadow mb-4">
  ...
  <thead>
    <tr>
      <th scope="col"><div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Category Name</div></th>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><div class="text-xs font-weight-bold text-success text-uppercase mb-1"><img src="{{$img->src}}" height="200" width="150"/></div></td>
